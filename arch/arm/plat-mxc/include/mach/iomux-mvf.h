...
#define MVF600_PAD41_PTB19__GPIO			\
		IOMUX_PAD(0x00a4, 0x00a4, 0, 0x0000, 0, \
				MVF600_GPIO_GENERAL_CTRL | PAD_CTL_IBE_ENABLE)
#define MVF600_PAD42_PTB20__GPIO			\
		IOMUX_PAD(0x00a8, 0x00a8, 0, 0x0000, 0, \
				MVF600_GPIO_GENERAL_CTRL | PAD_CTL_IBE_ENABLE)
#define MVF600_PAD25_PTB03__GPIO		\
		IOMUX_PAD(0x0064, 0x0064, 0, 0x0000, 0, \
				MVF600_GPIO_GENERAL_CTRL | PAD_CTL_IBE_ENABLE)
#define MVF600_PAD104_PTC31__GPIO	\
		IOMUX_PAD(0x01a0, 0x01a0, 0, 0x0000, 0, \
				MVF600_GPIO_GENERAL_CTRL | PAD_CTL_IBE_ENABLE)
#define MVF600_PAD35_PTB13__GPIO	\
		IOMUX_PAD(0x008C, 0x008C, 0, 0x0000, 0, \
				MVF600_GPIO_GENERAL_CTRL | PAD_CTL_IBE_ENABLE)


/* ACC-INT1*/
#define MVF600_PAD63_PTD31__ACC_INT1			\
		IOMUX_PAD(0x00fc, 0x00fc, 0, 0x0000, 0, \
				MVF600_GPIO_GENERAL_CTRL | PAD_CTL_IBE_ENABLE)
...
/* SPI_INT GPIO */
#define MVF600_PAD20_PTA30__SPI_INT	\
		IOMUX_PAD( 0x0050, 0x0050, 0, 0x0000, 0, \
				MVF600_GPIO_GENERAL_CTRL | PAD_CTL_IBE_ENABLE)
