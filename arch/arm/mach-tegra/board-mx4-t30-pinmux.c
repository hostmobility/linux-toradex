...
//requires INPUT even when operating as I2S master
	...
	I2C_PINMUX(GEN1_I2C_SCL, I2C1, PULL_UP, NORMAL, INPUT, DEFAULT, ENABLE),
	I2C_PINMUX(GEN1_I2C_SDA, I2C1, PULL_UP, NORMAL, INPUT, DEFAULT, ENABLE),
...
//GPIO N7: HOTPLUG_DETECT
	DEFAULT_PINMUX(HDMI_INT, RSVD0, PULL_DOWN, NORMAL, INPUT),
